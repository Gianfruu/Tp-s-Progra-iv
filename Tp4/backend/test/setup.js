...
//Limpiar todos los timers y handles abiertos después de cada suite de tests
afterAll(() => {
  //Limpiar la protección de brute force
  try {
    const bruteForceModule = require('../src/middleware/bruteForceProtection');
    bruteForceModule.failedAttempts.clear();
  } catch (e) {
